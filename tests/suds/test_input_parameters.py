...
xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/">
  ...
  <wsdl:service name="dummy">
    ...
    assert binding.__class__ is virtwho.virt.esx.suds.bindings.document.Document
...
xmlns:soap="http://schemas.xmlsoap.org/wsdl/soap/">
  ...
  <wsdl:service name="dummy">
    ...
    wsdl = virtwho.virt.esx.suds.byte_str("".join(wsdl))
    client = testutils.client_from_wsdl(wsdl, nosend=True)
    ...
    expected_param_defs = [
        (param_name, [virtwho.virt.esx.suds.bindings.binding.PartElement, param_name, my_type])
