...
<wsdl:definitions targetNamespace="first-namespace"
  ...
  <wsdl:service name="DummyService">
    ...
    external_schema = virtwho.virt.esx.suds.byte_str("""\
<?xml version='1.0' encoding='UTF-8'?>
<schema
  ...
  <element name="external" type="string"/>
    ...
    store = virtwho.virt.esx.suds.store.DocumentStore(external_schema=external_schema,
        wsdl=wsdl)
...
<Envelope xmlns="http://schemas.xmlsoap.org/soap/envelope/">
  ...
  <Body>
    ...
    # Passing a empty explicitly constructed `virtwho.virt.esx.suds.sudsobject.Object`.
