...
<xsd:element name="ZuZu">
   <xsd:simpleType>
    ...
    def create_test_element(content=str_formatted_xml):
        input_data = virtwho.virt.esx.suds.byte_str(content)
        xml = virtwho.virt.esx.suds.sax.parser.Parser().parse(virtwho.virt.esx.suds.BytesIO(input_data))
        element = xml.root()
    ...
    def test_convert_to_byte_str(self):
        ...
        expected = virtwho.virt.esx.suds.byte_str(element.str())
