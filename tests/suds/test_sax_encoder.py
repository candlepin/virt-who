...
import virtwho.virt.esx.suds.sax.enc
...
def test_decode(input, expected):
    assert virtwho.virt.esx.suds.sax.enc.Encoder().decode(input) == expected
...
def test_encode(input, expected):
    assert virtwho.virt.esx.suds.sax.enc.Encoder().encode(input) == expected
