...
""")
    ...
    assert isinstance(e1, virtwho.virt.esx.suds.xsd.sxbasic.Enumeration)
    assert isinstance(e2, virtwho.virt.esx.suds.xsd.sxbasic.Enumeration)
    assert isinstance(e3, virtwho.virt.esx.suds.xsd.sxbasic.Enumeration)
    assert e1.name == "One"
    assert e2.name == "Two"
...
""")
    ...
    assert isinstance(service.params[0][1], virtwho.virt.esx.suds.xsd.sxbuiltin.XString)
    assert service.params[1][0].name == "x2"
    assert service.params[1][0].type == ("UngaBunga", "my-namespace")
    assert isinstance(service.params[1][1], virtwho.virt.esx.suds.xsd.sxbasic.Complex)
    assert service.params[2][0].name == "x3"
    assert service.params[2][0].type == _string_type
    assert isinstance(service.params[2][1], virtwho.virt.esx.suds.xsd.sxbuiltin.XString)
...
""")
    ...
    assert isinstance(service.params[1][1], virtwho.virt.esx.suds.xsd.sxbuiltin.XString)
...
""")
    ...
    assert isinstance(service.params[1][1], virtwho.virt.esx.suds.xsd.sxbasic.Element)
    assert service.params[2][0].name == "x3"
    assert service.params[2][0].type == _string_type
    assert isinstance(service.params[2][1], virtwho.virt.esx.suds.xsd.sxbuiltin.XString)
...
""")
    ...
    assert isinstance(aType, virtwho.virt.esx.suds.xsd.sxbasic.Simple)
    ...
    assert isinstance(aType.rawchildren[0], virtwho.virt.esx.suds.xsd.sxbasic.Restriction)
...
""")
    ...
    assert isinstance(type_in, virtwho.virt.esx.suds.xsd.sxbasic.Complex)
    assert type_in.name == "Oklahoma"
    assert not type_in.sequence()
    assert type_in.rawchildren[0].sequence()

    type_out = service.types[1][0]
    assert isinstance(type_out, virtwho.virt.esx.suds.xsd.sxbasic.Complex)
...
""")
    ...
    aType = service.types[0][0]
    assert isinstance(aType, virtwho.virt.esx.suds.xsd.sxbasic.Complex)
    ...
    assert isinstance(sequence_node, virtwho.virt.esx.suds.xsd.sxbasic.Sequence)
...
""")
    ...
    assert isinstance(type_in1, virtwho.virt.esx.suds.xsd.sxbasic.Element)
    assert not type_in1.sequence()
    assert type_in1.rawchildren[0].rawchildren[0].sequence()
    type_in2 = children[1][0]
    assert isinstance(type_in2, virtwho.virt.esx.suds.xsd.sxbasic.Element)
...
""")
    ...
    pytest.raises(virtwho.virt.esx.suds.TypeNotFound, client.factory.create, "NonExistingType")
...
def test_parameter_referencing_missing_element(monkeypatch):
    ...
    monkeypatch.delitem(locals(), "e", False)
    e = pytest.raises(virtwho.virt.esx.suds.TypeNotFound, testutils.client_from_wsdl, wsdl)
    try:
...
""")
        assert pytest.raises(
            virtwho.virt.esx.suds.TypeNotFound, client.factory.create, 'ns:DoesNotExist')
...
<xsd:schema targetNamespace="my-xsd-namespace"
    xmlns:xsd="http://www.w3.org/2001/XMLSchema">
  <xsd:import namespace="my-xsd-namespace" schemaLocation="{url_imported}"/>
</xsd:schema>
""".format(url_imported=url_xsd).encode("utf-8")
    wsdl = """\
<?xml version='1.0' encoding='UTF-8'?>
<wsdl:definitions targetNamespace="my-wsdl-namespace"
    xmlns:wsdl="http://schemas.xmlsoap.org/wsdl/">
  <wsdl:import location="{url_imported}"/>
</wsdl:definitions>""".format(url_imported=url_xsd).encode("utf-8")
    store = virtwho.virt.esx.suds.store.DocumentStore(xsd=xsd)
...
""").encode("utf-8"))
    ...
    assert typo_u1.resolve().__class__ is virtwho.virt.esx.suds.xsd.sxbuiltin.XString
    assert typo_u1.resolve(nobuiltin=False).__class__ is  \
        virtwho.virt.esx.suds.xsd.sxbuiltin.XString
...
""")
    ...
    assert e1.resolve().__class__ is virtwho.virt.esx.suds.xsd.sxbuiltin.XString
    assert e1.resolve().__class__ is virtwho.virt.esx.suds.xsd.sxbuiltin.XString

    assert e2.resolve(nobuiltin=True) is e2
    assert e2.resolve(nobuiltin=True) is e2

    assert e3.resolve().__class__ is virtwho.virt.esx.suds.xsd.sxbuiltin.XString
    assert e3.resolve(nobuiltin=True) is e3
    assert e3.resolve(nobuiltin=True) is e3

    assert e4.resolve(nobuiltin=True) is e4
    assert e4.resolve().__class__ is virtwho.virt.esx.suds.xsd.sxbuiltin.XString
    assert e4.resolve().__class__ is virtwho.virt.esx.suds.xsd.sxbuiltin.XString
...
""")
    ...
    pytest.raises(virtwho.virt.esx.suds.TypeNotFound, elemento1.resolve)
    pytest.raises(virtwho.virt.esx.suds.TypeNotFound, elemento2.resolve)
    pytest.raises(virtwho.virt.esx.suds.TypeNotFound, elemento3.resolve)
...
""")
    ...
    assert isinstance(sequence, virtwho.virt.esx.suds.xsd.sxbasic.Sequence)
...
""")
    ...
    assert isinstance(element_in, virtwho.virt.esx.suds.xsd.sxbasic.Element)
    assert isinstance(element_out, virtwho.virt.esx.suds.xsd.sxbasic.Element)
    ...
    assert binding.__class__ is virtwho.virt.esx.suds.wsdl.Binding
    ...
    # virtwho.virt.esx.suds.serviceDefinition.ServiceDefinition.addports() docstring).
    ...
    assert type(param_ancestry[0]) is virtwho.virt.esx.suds.xsd.sxbasic.Element
    assert param_ancestry[0].name == "f"
    assert type(param_ancestry[1]) is virtwho.virt.esx.suds.xsd.sxbasic.Complex
    assert type(param_ancestry[2]) is virtwho.virt.esx.suds.xsd.sxbasic.Sequence
...
""")
    ...
    assert isinstance(elemento, virtwho.virt.esx.suds.xsd.sxbasic.Element)
    ...
    assert isinstance(unga_bunga, virtwho.virt.esx.suds.xsd.sxbasic.Complex)
...
def _assert_dynamic_type(anObject, typename):
    assert anObject.__module__ == virtwho.virt.esx.suds.sudsobject.__name__
    ...
    assert anObject.__class__.__module__ == virtwho.virt.esx.suds.sudsobject.__name__
