...
import virtwho.virt.esx.suds.sax.date
from virtwho.virt.esx.suds.xsd.sxbuiltin import (Factory, XAny, XBoolean, XBuiltin, XDate,
...
def _def_mock_xsd_class(x_class_name):
    ...
    """
    x_class = getattr(virtwho.virt.esx.suds.xsd.sxbuiltin, x_class_name)
...
class TestXBoolean:
    """virtwho.virt.esx.suds.xsd.sxbuiltin.XBoolean.translate() tests."""
...
class TestXDate:
    """
    virtwho.virt.esx.suds.xsd.sxbuiltin.XDate.translate() tests.
    ...
    def test_from_python_object__date(self):
        ...
        assert translated.__class__ is virtwho.virt.esx.suds.sax.date.Date
...
class TestXDateTime:
    """
    virtwho.virt.esx.suds.xsd.sxbuiltin.XDateTime.translate() tests.
    ...
    def test_from_python_object(self):
        ...
        assert translated.__class__ is virtwho.virt.esx.suds.sax.date.DateTime
...
class TestXDecimal:
    """virtwho.virt.esx.suds.xsd.sxbuiltin.XDecimal.translate() tests."""
...
class TestXFloat:
    """virtwho.virt.esx.suds.xsd.sxbuiltin.XFloat.translate() tests."""
...
class TestXInteger:
    """virtwho.virt.esx.suds.xsd.sxbuiltin.XInteger.translate() tests."""
...
class TestXLong:
    """virtwho.virt.esx.suds.xsd.sxbuiltin.XLong.translate() tests."""
...
class TestXTime:
    """
    virtwho.virt.esx.suds.xsd.sxbuiltin.XTime.translate() tests.
    ...
    def test_from_python_object(self):
        ...
        assert translated.__class__ is virtwho.virt.esx.suds.sax.date.Time
...
def _create_dummy_schema():
    ...
    # first having to construct a virtwho.virt.esx.suds.client.Client from a complete WSDL
    # schema.
