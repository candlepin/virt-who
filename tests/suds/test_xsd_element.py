...
import virtwho.virt.esx.suds.xsd.schema
...
<schema xmlns="http://www.w3.org/2001/XMLSchema"
    ...
    <element name="%(parent_name)s">
        ...
        schema = _parse_schema_xml(schema_xml.encode("utf-8"))
...
<schema xmlns="http://www.w3.org/2001/XMLSchema" targetNamespace="ns-there">
    <element name="Referenced"/>
        ...
        store = virtwho.virt.esx.suds.store.DocumentStore({"there.xsd": schema_xml_there.encode("utf-8")})
        schema = _parse_schema_xml(schema_xml_here.encode("utf-8"), store)
...
def _parse_schema_xml(xml, documentStore=None):
    ...
    options = virtwho.virt.esx.suds.options.Options(**options_kwargs)
    return virtwho.virt.esx.suds.xsd.schema.Schema(root, url, options)
