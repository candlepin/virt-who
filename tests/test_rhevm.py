...
class TestRhevM(TestBase):
    ...
    def test_connect(self, get):
        ...
        get.assert_has_calls([
            call('https://localhost:8443/api/clusters', verify=ANY, auth=ANY),
            call('https://localhost:8443/api/hosts', verify=ANY, auth=ANY),
            call('https://localhost:8443/api/vms', verify=ANY, auth=ANY),
        ])
