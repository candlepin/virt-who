...
%changelog
* Wed May 17 2023 Jiri Hnidek <jhnidek@redhat.com> 1.30.16-1
- Updated releaser configuration (jhnidek@redhat.com)
...
- 1986755: Remove the redundant 'update_interval' option from ahv config
  (wpoteat@redhat.com)
- 1986749: rename configuration entry to show ahv specificity
  (wpoteat@redhat.com)
