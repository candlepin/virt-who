...
import virtwho.virt.esx.suds.plugin
...
class Reader(object):
    ...
    def __init__(self, options):
        ...
        self.plugins = virtwho.virt.esx.suds.plugin.PluginContainer(options.plugins)
...
class DefinitionsReader(Reader):
    ...
    def __cache(self):
        ...
        return virtwho.virt.esx.suds.cache.NoCache()
...
class DocumentReader(Reader):
    ...
    def __fetch(self, url):
        ...
        if content is None:
            request = virtwho.virt.esx.suds.transport.Request(url)
        ...
        sax = virtwho.virt.esx.suds.sax.parser.Parser()
