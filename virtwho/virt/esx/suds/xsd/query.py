...
from virtwho.virt.esx.suds.sudsobject import *
from virtwho.virt.esx.suds.xsd import qualify, isqref
from virtwho.virt.esx.suds.xsd.sxbuiltin import Factory
...
class AttrQuery(Query):
    ...
    def __deepsearch(self, schema):
        from virtwho.virt.esx.suds.xsd.sxbasic import Attribute
        result = None
        for e in schema.all:
...
class ElementQuery(Query):
    ...
    def __deepsearch(self, schema):
        from virtwho.virt.esx.suds.xsd.sxbasic import Element
        result = None
        for e in schema.all:
